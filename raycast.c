...
/*   Updated: 2025/04/21 12:16:59 by enkwak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_texture	*get_texture_by_side(t_ray *ray, t_complete *game)
{
	if (ray->side == 0)
	{
		if (ray->ray_dir_x > 0)
...
static void	calc_raydir(t_ray *ray, t_player *player, int x)
{
