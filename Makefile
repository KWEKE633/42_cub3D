...
#    Updated: 2025/04/17 07:00:12 by enkwak           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# INCLUDES = -I./ -I./gnl -I./libft -I./minilibx
...
# $(NAME): $(OBJS) $(GNL_OBJS)
# 	$(MAKE) -C $(MLX_DIR)
# 	$(CC) $(CFLAGS) $(OBJS) $(GNL_OBJS) $(LIBFT_A) $(MLX_LIB) -o $(NAME)
...
SRCS = main.c \
	   parse.c parse_identifier.c parse_map.c validate_map.c utils.c player_rotate.c \
